# Config for training YOLOv2 model on nano blank no-aug Pascal VOC 2007&2012 Detection dataset for object detection debug
# as a lower-bound baseline for non-blanked nano VOC
...
#min_lr = 5e-6  # minimum learning rate, should be ~= learning_rate/10
