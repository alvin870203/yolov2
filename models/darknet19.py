...
class Darknet19(nn.Module):
    def __init__(self, config: Darknet19Config) -> None:
        ...
        self.head = nn.Sequential(
            nn.Conv2d(1024, 1000, bias=True, kernel_size=1, stride=1, padding=0),
    ...
    def _init_weights(self, module):
        raise NotImplementedError("FUTURE: init weights for Darknet19 model")
...
if __name__ == '__main__':
    # Test the model by `python -m model.darknet19` from the workspace directory
